...
If you set a different install path than the default (e.g. `/usr/local`), please remember to update your `PATH` environment variable so you have access to Calcha from anywhere in the filesystem
